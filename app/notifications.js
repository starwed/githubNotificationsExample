...
(function (NotificationReason) {
    ...
    NotificationReason[NotificationReason["author"] = 3] = "author";
    NotificationReason[NotificationReason["comment"] = 4] = "comment";
    NotificationReason[NotificationReason["mention"] = 5] = "mention";
